...
CGVermelho = new Group();
  ciclistaPrincipal.setCollider("circle",0,0,100);
...
function draw() {
 ...
 ciclistaPrincipal.addAnimation("dying",img2CiclistaPrincipal);
